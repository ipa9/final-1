...
public class PostsRepositoryTests
{
    ...
    {
        var dbName2 = Guid.NewGuid().ToString();     // give unqie name to the database, so that different tests don't interfere with each other
        ...
        context.Posts.AddRange(
            new Post { Id = 1, Title = "First Post", Content = "Content 1", Upvotes = 10, Downvotes = 2 }, // 10 / 12 = 0.8333333333333333
            new Post { Id = 2, Title = "Second Post", Content = "Content 2", Upvotes = 5, Downvotes = 1 },// 5 /6
            new Post { Id = 3, Title = "Third Post", Content = "Content 3", Upvotes = 20, Downvotes = 5 } // 20 / 25 = 0.8
        );
